              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  ?>
                    <tr>
                      <td><?php echo $i; ?></td>
                      <td><?php if($row['app_2']=="1"){ echo "Betxp"; } else { echo "Balaji"; } ?></td>
            ...
            <form method="POST"  enctype="multipart/form-data" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                                <label>is for 2nd app ?</label>
                                <select id="app_2" name="app_2" class="form-control" style="width: 100%;">
...
if(isset($_POST['CreateNew'])){
  ...
  $insert = mysqli_query($con, "INSERT INTO `image_slider`( `image`,`verify`,`refer`,`data`,`app_2`) 
                                                          VALUES ('$target_file','$verify','$redirect','$data','$app_2')");
      if($insert){
          echo "<script>window.location.href = 'image_slider.php';</script>";
      }else{
