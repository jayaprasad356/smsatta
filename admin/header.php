...
function sendNotification($body,$title,$topic){
    ...
    $headers = array
    (
        'Authorization: key=AAAA9xoY1LM:APA91bH6EcZHSeC0lx8dT2hq8CKuDzVAHjMUBMQ8VTf2uowMLfOrwoEE4c-UQS47JRb4rOhPzkr23ARs7weXT4Ht0X0kT31ZdvRKKLcn6QFTYuXCp9g08350lV4o4giq3RQzsKwpfAeo',
...
<link rel="icon" href="images/logomain.png" type="image/icon">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard.php" class="brand-link">
      <img src="dist/img/logomain.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="refers.php" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Refers
                <span class="right badge badge-danger">New</span>
           ...
           <li class="nav-item">
            <a href="chats.php" class="nav-link">
              ...
              <p>
                Chat Inbox
                <span class="right badge badge-danger"><?php echo mysqli_num_rows(mysqli_query($con,"select sn from admin_chats where user!='admin' AND seen='0'")); ?></span>
              </p>
            </a>
          </li>
          <li class="nav-item">
